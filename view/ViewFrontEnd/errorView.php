...
<html lang="fr">
	...
	<body>
		...
		<main>
			...
			<div class="gpButton">
					<a class="button deconnectAccueil" href="index?action=accueil">Retour à la page précédente</a>
					<a class="button deconnectAccueil" href="index?action=accueil">Retour à la page d'accueil</a>
			</div>
